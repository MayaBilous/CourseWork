    ...
    override fun onCreate() {
        ...
        coroutineScope.launch {
            ...
            if (db.SportSectionDao().getSectionsWithDetails().isEmpty()) {
                ...
                db.SportSectionDao().addSportSection(sportSection1, sportSection2, sportSection3, sportSection4)
                ...
                val sectionDetailsList = listOf(
                    ...
                    DbSectionDetails(id = 1, sectionId = 1, address = "вул. Баскетбольна, 15", workingDays = "Пн-Пт, 10:00-20:00", phoneNumber = "0509876543", price = 400, isSelected = false),
                    DbSectionDetails(id = 2, sectionId = 2, address = "вул. Волейбольна, 20", workingDays = "Пн-Сб, 8:00-17:00", phoneNumber = "0631122334", price = 450, isSelected = false),
                    DbSectionDetails(id = 3, sectionId = 3, address = "вул. Тенісна, 8", workingDays = "Пн-Пт, 9:00-19:00", phoneNumber = "0662233445", price = 600, isSelected = false),
                    DbSectionDetails(id = 4, sectionId = 1, address = "вул. Баскетбольна, 18", workingDays = "Пн-Пт, 9:00-18:00", phoneNumber = "0509876543", price = 420, isSelected = false)
                )
